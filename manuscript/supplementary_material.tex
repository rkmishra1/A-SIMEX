...
% Gaurav Garg (corresponding author) and Ramakrushna Mishra
% Section S1: proofs. Section S2: implementation details.
% ===========================================================================
...
``Adaptive SIMEX for Poisson Regression with Classical Measurement
Error: Theory, Methods, and Applications''}\\[6pt]
Gaurav Garg and Ramakrushna Mishra\\[4pt]
{\small Decision Sciences Area, Indian Institute of Management
Lucknow, Uttar Pradesh, India}
\end{center}

\bigskip

This supplementary document contains the complete proofs of all
results stated in Section~4 of the main text (Section~\ref{sec:proofs}
below) and the implementation details referenced in
Section~7 of the main text (Section~\ref{sec:impl} below).
Assumptions, lemmas, and theorems are restated for convenience;
statements are identical to the main text and carry S-prefixed
numbers.
...
\texttt{se\_method = "sandwich"} uses the analytic sandwich, and
